...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased dark:bg-black dark:text-white/50" class="h-full">
<div class="min-h-full">
    ...
    <header class="bg-white shadow-sm">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8 sm:flex sm:justify-between">
            ...
            <a href="/jobs/create" class="text-blue-500 hover:text-blue-700 font-semibold">Create Jobs</a>
        </div>
    </header>
    <main>
